 ...
 * prompt, deliberately separate from Gold's three pinned engine prompts in
 * `prompts.ts` (those are pinned byte-for-byte against `../PROMPTS.md`; this
 * file is new surface: it answers from model knowledge, in Review only).
 *

...
import type { GeminiAdapter, VisionResult } from '../../../src/providers/types'
import { saveGeminiKey } from '../../../src/state/credentials'
import { db } from '../../../src/state/db'
import { createRun, getRun, putArtifact, updateRun } from '../../../src/state/runs'
import {
  clearAiAnswers,
  readAiAnswers,
  solveRows,
...
async function seedRun(rows: ExamQuestion[]): Promise<string> {

...
// Owner-approved 2026-07-15 (ENGINE.md §1.10, PROMPTS.md §2.2): the printed case identity
...
export function assembleBlueprint(input: AssembleInput): Blueprint {
  ...
  return {
    // The one contract list, never a re-typed copy that can drift from it.
    ...
    planned_rows: rows,
    worker_constraints: {
      may_add_rows: false, may_remove_rows: false,

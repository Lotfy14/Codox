/**
 * RFC-4180 emit of the Triviadox contract (§3.1–3.2). Hand-rolled after the
 * 2026-07-12 package search: every maintained writer (papaparse,
 ...
 */
import { CSV_SCHEMA, type ExamQuestion } from './types'
...
/** Emits the complete PDF-named CSV content for a run's questions. */
export function emitCsv(rows: readonly ExamQuestion[]): string {
